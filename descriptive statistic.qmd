...
final_data$ideo <- scale(final_data$ideo)  

control_settings <- glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 100000))

model1<- glmer(transgender_civil_dc ~ gender + religion + ideo + 
                  (1 | iso3c), 
                data = final_data, 
                family = binomial, 
...
model2 <- glmer(transgender_civil_dc ~ gender + gender_squared + religion + ideo + (1 | iso3c),
                data = final_data,
                family = binomial,
...
model_multinomial <- multinom(transgender_civil_dc ~ gender + religion + ideo,
                              data = final_data)
...
cv_model <- train(transgender_civil_dc ~ gender + religion + ideo,
                  data = final_data,
